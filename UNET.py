...
es = EarlyStopping(monitor='val_acc', min_delta=0.001,mode='max', verbose=1,patience=3)
...
model.fit_generator(generator=training_generator,validation_data=validation_generator, \
                    epochs=10, verbose=2, callbacks=[es])

model.save('my_model_lbp_10_20_976px_line_bold.h5')
